    ...
    public class LocationsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Locations != null ? 
                          ...
                          Problem("Entity set 'InventoryContext.Locations'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'InventoryContext.Locations'  is null.");
            }
            var location = await _context.Locations.FindAsync(id);
            if (location != null)
            {
                List<Relationship> relations = await _context.Relationships.ToListAsync();
                foreach (Relationship rel in relations)
                {
                    if(rel.LocationId == location.Id)
                    {
